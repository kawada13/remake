...
export default {
  ...
  created() {
    if(this.$route.name == 'exhibited-products' || this.$route.name == 'creater-info-edit' || this.$route.name == 'transfer-account-setting' || this.$route.name == 'audio-create' || this.$route.name == 'audio-edit')
    {
      this.createrClass = true
    }
